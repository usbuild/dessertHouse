function apprise(string, args, callback) {
    ...
    if (args) {
        if (args['confirm'] || args['input']) {
            ...
            $('.aButtons').append('<button value="cancel" class="btn btn-danger">' + args['textCancel'] + '</button>');
        }
        else if (args['verify']) {
            $('.aButtons').append('<button value="ok" class="btn btn-primary>' + args['textYes'] + '</button>');
            $('.aButtons').append('<button value="cancel" class="btn btn-danger">' + args['textNo'] + '</button>');
        }
        else {
            $('.aButtons').append('<button value="ok" class="btn btn-primary">' + args['textOk'] + '</button>');
        }
